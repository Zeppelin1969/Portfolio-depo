    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I&apos;m Suraj Singh Bhandari</p>
            <p className="subtext">
              Motivated, aspiring Data Analyst with a strong background in Computer Engineering, Mathematics, and Statistics. I specialize in building automated clinical data pipelines using Python and Pandas. With a passion for AI-assisted programming and analysis, I am driven to generate regulatory-compliant Tables, Listings, and Figures (TLFs) to support evidence-based decision-making in the healthcare industry.
            </p>
          </div>
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I&apos;m based in Kathmandu, Nepal, and open to remote work worldwide
            </p>
          </div>
